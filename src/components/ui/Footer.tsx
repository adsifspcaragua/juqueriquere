    ...
    return (
        <footer className="vertical">
            <div className="vertical justify w100 gap30">      
                <div className="vertical gap30 w100 justify" id="footerLinha1">
                ...
                <div className="vertical gap5 left">
                    <h5>Desenvolvido por estudantes do IFSP Campus Caraguatatuba.</h5>
                    <Link to={"/desenvolvimento"}>Conheça a equipe e o desenvolvimento →</Link>
                </div>
            </div>
            <div className="vertical gap15 justifyRight right w100" id="footerLinha3">
